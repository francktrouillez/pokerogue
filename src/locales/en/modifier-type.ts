...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    ...
    TOXIC_ORB: {
      name: "Toxic Orb",
      description: "Badly poisons its holder at the end of the turn if they do not have a status condition already"
    },
    FLAME_ORB: {
      name: "Flame Orb",
      description: "Burns its holder at the end of the turn if they do not have a status condition already"
    },
    ...
    ENEMY_HEAL: {
      name: "Recovery Token",
      description: "Heals 2% of max HP every turn"
    },
