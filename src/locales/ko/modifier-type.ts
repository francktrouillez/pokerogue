...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    ...
    MEGA_BRACELET: {
      name: "메가링",
      description: "메가스톤을 사용 가능"
    },
    DYNAMAX_BAND: {
      name: "다이맥스 밴드",
      description: "다이버섯을 사용 가능"
    },
    TERA_ORB: {
      name: "테라스탈오브",
      description: "테라피스를 사용 가능"
    },
    MAP: {
      name: "지도",
      description: "갈림길에서 목적지 선택 가능"
    },
    POTION: {
      name: "상처약"
    },
    ...
    REVIVER_SEED: {
      name: "부활의씨앗",
      description: "포켓몬이 쓰러지려 할 때 HP를 절반 회복"
    },
    ETHER: {
      name: "PP에이드"
    },
    ...
    MEMORY_MUSHROOM: {
      name: "기억버섯",
      description: "포켓몬의 잊어버린 기술을 떠올림"
    },
    EXP_SHARE: {
      name: "학습장치",
      description: "배틀에 참여하지 않아도 20%의 경험치를 받을 수 있는 장치"
    },
    EXP_BALANCE: {
      name: "균형학습장치",
      description: "레벨이 낮은 포켓몬이 받는 경험치를 가중"
    },
    OVAL_CHARM: {
      name: "둥근부적",
      description: "여러 마리의 포켓몬이 배틀에 참여할 경우, 전체 경험치의 10%씩을 추가로 획득"
    },
    EXP_CHARM: {
      name: "경험부적"
    },
    ...
    SOUL_DEW: {
      name: "마음의물방울",
      description: "지닌 포켓몬의 성격의 효과가 10% 증가 (합연산)"
    },
    NUGGET: {
      name: "금구슬"
    },
    ...
    AMULET_COIN: {
      name: "부적금화",
      description: "받는 돈이 20% 증가"
    },
    GOLDEN_PUNCH: {
      name: "골든펀치",
      description: "주는 데미지의 50%만큼 돈을 획득"
    },
    COIN_CASE: {
      name: "동전케이스",
      description: "매 열 번째 배틀마다, 가진 돈의 10%를 이자로 획득"
    },
    LOCK_CAPSULE: {
      name: "록캡슐",
      description: "받을 아이템을 갱신할 때 희귀도를 고정 가능"
    },
    GRIP_CLAW: {
      name: "끈기갈고리손톱"
    },
    ...
    HEALING_CHARM: {
      name: "치유의부적",
      description: "HP를 회복하는 기술을 썼을 때 효율이 10% 증가 (부활 제외)"
    },
    CANDY_JAR: {
      name: "사탕단지",
      description: "이상한사탕 종류의 아이템이 올려주는 레벨 1 증가"
    },
    BERRY_POUCH: {
      name: "열매주머니",
      description: "사용한 나무열매가 소모되지 않을 확률 33% 추가"
    },
    FOCUS_BAND: {
      name: "기합의머리띠",
      description: "기절할 듯한 데미지를 받아도 HP를 1 남겨서 견딜 확률 10% 추가"
    },
    QUICK_CLAW: {
      name: "선제공격손톱",
      description: "상대보다 먼저 행동할 수 있게 될 확률 10% 추가 (우선도 처리 이후)"
    },
    KINGS_ROCK: {
      name: "왕의징표석",
      description: "공격해서 데미지를 줄 때 상대를 풀죽일 확률 10% 추가"
    },
    LEFTOVERS: {
      name: "먹다남은음식",
      description: "포켓몬의 HP가 매 턴 최대 체력의 1/16씩 회복"
    },
    SHELL_BELL: {
      name: "조개껍질방울",
      description: "포켓몬이 준 데미지의 1/8씩 회복"
    },
    TOXIC_ORB: {
      name: "맹독구슬",
      description: "이 도구를 지닌 포켓몬은 턴이 끝나는 시점에 상태이상에 걸리지 않았다면 맹독 상태가 된다."
    },
    FLAME_ORB: {
      name: "화염구슬",
    ...
    SHINY_CHARM: {
      name: "빛나는부적",
      description: "야생 포켓몬이 색이 다른 포켓몬으로 등장할 확률을 급격히 증가"
    },
    ABILITY_CHARM: {
      name: "특성부적",
      description: "야생 포켓몬이 숨겨진 특성을 가지고 등장할 확률을 급격히 증가"
    },
    IV_SCANNER: {
      name: "개체값탐지기",
      description: "야생 포켓몬의 개체값을 확인 가능하다. 높은 값이 먼저 표시되며 확인할 수 있는 개체값을 두 종류씩 추가"
    },
    DNA_SPLICERS: {
      name: "유전자쐐기"
    },
    ...
    GOLDEN_POKEBALL: {
      name: "황금몬스터볼",
      description: "전투 후 획득하는 아이템의 선택지를 하나 더 추가"
    },
    ENEMY_DAMAGE_BOOSTER: {
      name: "데미지 토큰",
      description: "주는 데미지를 5% 증가"
    },
    ENEMY_DAMAGE_REDUCTION: {
      name: "보호 토큰",
      description: "받는 데미지를 2.5% 감소"
    },
    ENEMY_HEAL: {
      name: "회복 토큰",
      description: "매 턴 최대 체력의 2%를 회복"
    },
    ...
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      name: "만병통치 토큰",
      description: "매 턴 상태이상에서 회복될 확률 10% 추가"
    },
    ENEMY_ENDURE_CHANCE: {
      name: "버티기 토큰"
    },
    ENEMY_FUSED_CHANCE: {
      name: "합체 토큰",
      description: "야생 포켓몬이 합체할 확률 1% 추가"
    }
  },
