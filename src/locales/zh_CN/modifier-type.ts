...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    ...
    DYNAMAX_BAND: {
      name: "极巨腕带",
      description: "能让携带着极巨菇菇战斗的宝可梦进行\n极巨化"
    },
    TERA_ORB: {
      name: "太晶珠",
      description: "能让携带着太晶碎块战斗的宝可梦进行\n太晶化"
    },
    MAP: {
      name: "地图",
      description: "允许你在切换宝可梦群落时选择目的地"
    },
    POTION: {
      name: "伤药"
    },
    ...
    MEMORY_MUSHROOM: {
      name: "回忆蘑菇",
      description: "回忆一个宝可梦已经遗忘的招式"
    },
    EXP_SHARE: {
      name: "学习装置",
      description: "未参加对战的宝可梦获得20%的经验值"
    },
    EXP_BALANCE: {
      name: "均衡型学习装置",
      description: "队伍中的低级宝可梦获得更多经验值"
    },
    OVAL_CHARM: {
      name: "圆形护符",
    ...
    AMULET_COIN: {
      name: "护符金币",
      description: "金钱奖励增加20%"
    },
    GOLDEN_PUNCH: {
      name: "黄金拳头",
      description: "将50%造成的伤害转换为金钱"
    },
    COIN_CASE: {
      name: "代币盒",
      description: "每十场战斗, 获得自己金钱10%的利息"
    },
    LOCK_CAPSULE: {
      name: "上锁的容器",
      description: "允许在刷新物品时锁定物品稀有度"
    },
    GRIP_CLAW: {
      name: "紧缠钩爪"
    },
    ...
    HEALING_CHARM: {
      name: "治愈护符",
      description: "HP回复量增加10% (含复活)"
    },
    CANDY_JAR: {
      name: "糖果罐",
      description: "神奇糖果提供的升级额外增加1级"
    },
    BERRY_POUCH: {
      name: "树果袋",
    ...
    FOCUS_BAND: {
      name: "气势头带",
      description: "携带该道具的宝可梦有10%几率在受到\n攻击而将陷入濒死状态时，保留1点HP不陷入濒死状态"
    },
    QUICK_CLAW: {
      name: "先制之爪",
    ...
    KINGS_ROCK: {
      name: "王者之证",
      description: "携带该道具的宝可梦使用任意原本不会造成\n畏缩状态的攻击招式并造成伤害时，有\n10%几率使目标陷入畏缩状态"
    },
    LEFTOVERS: {
      name: "吃剩的东西",
    ...
    SHELL_BELL: {
      name: "贝壳之铃",
      description: "携带该道具的宝可梦在攻击对方成功造成伤\n害时，携带者的HP会恢复其所造成伤害\n的1/8"
    },
    TOXIC_ORB: {
      name: "Toxic Orb",
      description: "It's a bizarre orb that exudes toxins when touched and will badly poison the holder during battle"
    },
    FLAME_ORB: {
      name: "Flame Orb",
      description: "It's a bizarre orb that gives off heat when touched and will affect the holder with a burn during battle"
    },
    BATON: {
      name: "接力棒",
    ...
    SHINY_CHARM: {
      name: "闪耀护符",
      description: "显著增加野生宝可梦的闪光概率"
    },
    ABILITY_CHARM: {
      name: "特性护符",
      description: "显著增加野生宝可梦有隐藏特性的概率"
    },
    IV_SCANNER: {
      name: "个体值探测器",
      description: "允许扫描野生宝可梦的个体值。可叠加，每多拥有一个多显示\n2项个体值. 最好的个体值优先显示"
    },
    DNA_SPLICERS: {
      name: "基因之楔"
    },
    ...
    GOLDEN_POKEBALL: {
      name: "黄金精灵球",
      description: "在每场战斗结束后增加一个额外物品选项"
    },
    ENEMY_DAMAGE_BOOSTER: {
      name: "伤害硬币",
      description: "增加5%造成伤害"
    },
    ENEMY_DAMAGE_REDUCTION: {
      name: "防御硬币",
      description: "减少2.5%承受伤害"
    },
    ENEMY_HEAL: {
      name: "回复硬币",
      description: "每回合回复2%最大HP"
    },
