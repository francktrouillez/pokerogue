...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    ...
    RARER_CANDY: {
      name: "Caramella Molto Rara"
    },
    MEGA_BRACELET: {
      name: "Megapolsiera",
      description: "Le Megapietre sono disponibili"
    },
    DYNAMAX_BAND: {
      name: "Polsino Dynamax",
      description: "I Fungomax sono disponibili"
    },
    TERA_ORB: {
      name: "Terasfera",
      description: "I Teraliti sono disponibili"
    },
    MAP: {
      name: "Mappa",
      description: "Permette di scegliere la propria strada a un bivio"
    },
    POTION: {
      name: "Pozione"
    },
    ...
    FULL_RESTORE: {
      name: "Ricarica Totale"
    },
    REVIVE: {
      name: "Revitalizzante"
    },
    MAX_REVIVE: {
      name: "Revitalizzante Max"
    },
    FULL_HEAL: {
      name: "Cura Totale"
    },
    ...
    SUPER_LURE: {
      name: "Profumo Invito Super"
    },
    MAX_LURE: {
      name: "Profumo Invito Max"
    },
    MEMORY_MUSHROOM: {
    ...
    EXP_SHARE: {
      ...
      description: "Tutti i Pokémon della squadra ricevono il 20% dei Punti Esperienza dalla lotta anche se non vi hanno partecipato"
    },
    EXP_BALANCE: {
      name: "Bilancia Esperienza",
      description: "Bilancia i Punti Esperienza ricevuti verso i Pokémon del gruppo di livello inferiore"
    },
    OVAL_CHARM: {
      name: "Ovamuleto",
      description: "Quando più Pokémon partecipano a una battaglia, ognuno di essi riceve il 10% in più dell'esperienza totale"
    },
    EXP_CHARM: {
      name: "Esperienzamuleto"
    },
    SUPER_EXP_CHARM: {
      name: "Esperienzamuleto Super"
    },
    GOLDEN_EXP_CHARM: {
      name: "Esperienzamuleto Oro"
    },
    LUCKY_EGG: {
      name: "Uovo Fortunato"
    },
    ...
    SOUL_DEW: {
      name: "Cuorugiada",
      description: "Aumenta del 10% l'influenza della natura di un Pokémon sulle sue statistiche (Aggiuntivo)"
    },
    NUGGET: {
      name: "Pepita"
    },
    ...
    AMULET_COIN: {
      name: "Monetamuleto",
      description: "Aumenta le ricompense in denaro del 20%"
    },
    GOLDEN_PUNCH: {
      name: "Pugno Dorato",
    ...
    LOCK_CAPSULE: {
      ...
      description: "Permette di bloccare le rarità degli oggetti quando si fa un reroll degli oggetti"
    },
    GRIP_CLAW: {
      name: "Presartigli"
    },
    ...
    HEALING_CHARM: {
      name: "Curamuleto",
      description: "Aumenta del 10% l'efficacia delle mosse e degli oggetti che ripristinano i PS (escluse le rianimazioni)"
    },
    CANDY_JAR: {
    ...
    FOCUS_BAND: {
      name: "Bandana",
      description: "Chi ce l'ha ottiene il 10% di possibilità aggiuntivo di evitare un potenziale KO e rimanere con un solo PS"
    },
    QUICK_CLAW: {
      name: "Rapidartigli",
      description: "Aggiunge una probabilità del 10% di muoversi per primi, indipendentemente dalla velocità (dopo la priorità)"
    },
    KINGS_ROCK: {
      name: "Roccia di re",
      description: "Aggiunge il 10% di possibilità che una mossa d'attacco faccia tentennare l'avversario"
    },
    LEFTOVERS: {
      name: "Avanzi",
    ...
    SHINY_CHARM: {
      name: "Cromamuleto",
      description: "Misterioso amuleto luminoso che aumenta la probabilità di incontrare Pokémon cromatici"
    },
    ABILITY_CHARM: {
      name: "Abilitamuleto",
      description: "Aumenta drasticamente la possibilità che un Pokémon selvatico abbia un'abilità nascosta"
    },
    IV_SCANNER: {
      name: "Scanner IV",
      description: "Permette di scansionare gli IV dei Pokémon selvatici. Vengono rivelati 2 IV per pila. I migliori IV vengono mostrati per primi"
    },
    DNA_SPLICERS: {
      name: "	Cuneo DNA"
    },
    MINI_BLACK_HOLE: {
      name: "Piccolo Buco Nero"
    },
    GOLDEN_POKEBALL: {
      name: "Poké Ball Oro",
    ...
    ENEMY_DAMAGE_BOOSTER: {
      name: "Gettone del Danno",
      description: "Aumenta il danno del 5%"
    },
    ...
    ENEMY_ATTACK_POISON_CHANCE: {
      name: "Gettone del Veleno"
    },
    ENEMY_ATTACK_PARALYZE_CHANCE: {
      name: "Gettone della Paralisi"
    },
    ENEMY_ATTACK_SLEEP_CHANCE: {
      name: "Gettone del Sonno"
    },
    ENEMY_ATTACK_FREEZE_CHANCE: {
      name: "Gettone del Congelamento"
    },
    ENEMY_ATTACK_BURN_CHANCE: {
      name: "Gettone della Bruciatura"
    },
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      name: "Gettone Guarigione Completa",
      description: "Aggiunge una probabilità del 10% a ogni turno di curare una condizione di stato"
    },
    ENEMY_ENDURE_CHANCE: {
      name: "Gettone di Resistenza"
    },
    ENEMY_FUSED_CHANCE: {
