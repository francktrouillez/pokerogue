...
export const ability: AbilityTranslationEntries = {
  ...
  powerOfAlchemy: {
    name: "Le pouvoir de l'alchimie",
    description: "Le Pokémon copie la capacité d'un allié vaincu."
  },
  rksSystem: {
    name: "Système RKS",
    description: "Change le type du Pokémon pour qu'il corresponde au disque de mémoire qu'il détient."
  }
} as const;
