...
\nI'm really sorry you had a bad experience because of me!`,
  ...
  firebreather: {
    encounter: {
      1: "Mes flammes vous dévoreront !",
      2: "Mon âme est en feu. Je vais vous montrer à quel point elle brûle !",
      3: "Venez jeter un coup d'œil !"
    },
    victory: {
      1: "J'ai été réduit en cendres...",
      2: "Yow ! C'est chaud !",
      3: "Aïe ! J'ai brûlé le bout de mon nez !"
    }
  }
};
...
export const PGMmiscDialogue: SimpleTranslationEntries = {
  ...
  ending_endless: "Félicitations pour avoir atteint la fin de ce site !\nD'autres contenus seront bientôt disponibles.",
  ending_name: "Développeurs"
};
