...
export const move: MoveTranslationEntries = {
  ...
  "viseGrip": {
    name: "Punho de torno",
    effect: "O alvo é agarrado e apertado de ambos os lados para infligir danos."
  },
  "forestsCurse": {
    name: "Maldição da floresta",
    effect: "O usuário lança uma maldição florestal no alvo. O alvo agora também é do tipo Grama."
  },
  "kingsShield": {
    name: "Escudo do Rei",
    effect: "O usuário assume uma postura defensiva enquanto se protege de danos. Ele também reduz a estatística de ataque de qualquer atacante que faça contato direto."
  },
  "landsWrath": {
    name: "Ira da terra",
    effect: "O usuário reúne a energia da terra e concentra esse poder em Pokémon adversários para danificá-los."
  },
  "tenMillionVoltThunderbolt": {
    name: "Thunderbolt de 10.000.000 Volts",
    effect: "O usuário, o Pikachu usando um boné, gera um choque de eletricidade usando seu Z-Power e o libera. Os acertos críticos ocorrem com mais facilidade."
  }
} as const;
